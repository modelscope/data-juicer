...
from data_juicer.core.sandbox.model_executors import ModelscopeInferProbeExecutor, ModelscopeTrainExecutor
...
class DataEvaluatorFactory(object):
    ...
    def __call__(self, eval_cfg: dict = None, *args, **kwargs):
        ...
        if eval_cfg.type == "vbench_video_evaluator":
            from data_juicer.core.sandbox.specific_hooks.text_to_video.model_hooks import VBenchEvaluator
...
class ModelTrainExecutorFactory(object):
    def __call__(self, model_cfg: dict = None, *args, **kwargs):
        ...
        if model_cfg.type == "modelscope":
            ...
            from data_juicer.core.sandbox.specific_hooks.text_to_video.model_hooks import EasyAnimateTrainExecutor

            trainer = EasyAnimateTrainExecutor(model_cfg, **kwargs)
        elif model_cfg.type == "trinity-rft":
            from data_juicer.core.sandbox.specific_hooks.rft.model_hooks import TrinityRFTTrainExecutor
...
class ModelInferExecutorFactory(object):
    def __call__(self, generate_cfg: dict = None, *args, **kwargs):
        ...
        if generate_cfg.type == "easyanimate":
            from data_juicer.core.sandbox.specific_hooks.text_to_video.model_hooks import EasyAnimateInferExecutor
