...
class CharacterRepetitionFilter(Filter):
    ...
    filters out samples that do not fall within the specified range. The n-gram length,
    minimum, and maximum ratios are configurable. The repetition ratio is computed based on
    the frequency of n-grams in the text. The key metric 'char_rep_ratio' is cached in the
    stats field. Samples are kept if their 'char_rep_ratio' is between the specified min and
    max ratios."""
