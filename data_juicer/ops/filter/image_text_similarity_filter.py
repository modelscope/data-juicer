...
class ImageTextSimilarityFilter(Filter):
    ...
    and text. It keeps samples where the similarity scores fall within the given range. The
    similarity score is computed for each image-text pair, and the final score can be
