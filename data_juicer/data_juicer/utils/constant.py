...
class Fields(object):
    ...
    # ASD_mapper
    # ASD_attribute = DEFAULT_PREFIX + 'ASD_attribute_'
    human_track_data_path = DEFAULT_PREFIX + 'human_track_data_path_'
    # audio_attribute_mapper
    audio_speech_attribute = DEFAULT_PREFIX + 'audio_speech_attribute_'
    # video caption from tracks
    track_video_caption = DEFAULT_PREFIX + 'track_video_caption_'
    # video_caption
    video_caption = DEFAULT_PREFIX + 'video_caption_'
    # face_attribute
    video_facetrack_attribute_emotion = DEFAULT_PREFIX + 'video_facetrack_attribute_emotion_'
    video_facetrack_is_child = DEFAULT_PREFIX + 'video_facetrack_is_child_'
    # audio annotation
    # speech_annotation = DEFAULT_PREFIX + 'speech_annotation_'
    speech_ASR = DEFAULT_PREFIX + 'speech_ASR_'
    speech_emotion = DEFAULT_PREFIX + 'speech_emotion_'
    # video_facetrack_attribute_demographic
    video_facetrack_attribute_demographic = DEFAULT_PREFIX + 'video_facetrack_attribute_demographic_'
    # ASD revise flag
    ASD_revise_flag = DEFAULT_PREFIX + 'ASD_revise_flag_'
    # min_people_in_video
    min_people_in_video = DEFAULT_PREFIX + 'min_people_in_video_'
    # my_summarization
    my_summarization = DEFAULT_PREFIX + 'my_summarization_'
    # human_face_emotion_class
    human_face_emotion_class = DEFAULT_PREFIX + 'human_face_emotion_class_'
    human_appearance = DEFAULT_PREFIX + 'human_face_emotion_class_'
    # human_emotion_Q_12
    human_emotion_Q_12 = DEFAULT_PREFIX + 'human_emotion_Q_12_'
    human_behavior_sequence = DEFAULT_PREFIX + 'human_behavior_sequence_'
