    ...
    image_messages = [
        {
            ...
            "content": [
                ...
                {
                    "type": "text", 
                    "text": config_img.system_prompt + "\nOriginal Question: \n" + question + "\nOriginal Answer: \n" + answer + "\n" + config_img.user_prompt_subquestion
                },
            ],
        }
    ]
    ...
    image_messages = [
        {
            ...
            "content": [
                ...
                {
                    "type": "text",
                    "text": config_img.system_prompt + "\nSub Questions: \n" + sub_questions + "\n" + config_img.user_prompt_multihop
                }
            ],
        }
    ]
...
def main(rank, gpu_id, per_num, shared_list, output_dir, filtered_data): 
    ...
    for i in tqdm(range(per_num), desc="Running Inference"):
        try:
            ...
            with open(os.path.join(output_dir, f"thinking-{per_num}_{rank}.json"), "w", encoding="utf-8") as f:
...
if __name__ == '__main__':
    ...
    with open(os.path.join(output_dir, f"thinking-{example_num}.json"), "w", encoding="utf-8") as f:
