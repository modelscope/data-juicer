...
Data-Juicer 现已上架 PyPI，您可以通过以下方式安装：
...
# 或安装特定组
pip install -e ".[sci]"    # 科学计算依赖
pip install -e ".[dev]"    # 开发工具
pip install -e ".[tools]"  # 工具依赖
...
`uv` 是一个用 Rust 编写的快速 Python 包安装器和解析器。您可以通过以下方式安装：
