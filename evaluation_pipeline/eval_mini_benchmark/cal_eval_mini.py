...
if __name__ == "__main__":
    ...
    character_attributes_detect_count = {"animal":0, "object":0, "person":0}
    ...
    for temp_name in file_name:
        if args.name_prefix in temp_name and "overall" in temp_name:
            ...
            with open(os.path.join(dir_name, temp_name), "r") as f:
                ...
                character_attributes_detect_count["animal"] += temp_json["character_attributes_detect_count"]["animal"]
                character_attributes_detect_count["object"] += temp_json["character_attributes_detect_count"]["object"]
                character_attributes_detect_count["person"] += temp_json["character_attributes_detect_count"]["person"]
    ...
    acc["character_attributes_animal_detect"] = round(character_attributes_success_count["animal"]/character_attributes_detect_count["animal"], 4)
    acc["character_attributes_object_detect"] = round(character_attributes_success_count["object"]/character_attributes_detect_count["object"], 4)
    acc["character_attributes_person_detect"] = round(character_attributes_success_count["person"]/character_attributes_detect_count["person"], 4)
