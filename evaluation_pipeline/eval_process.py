...
if __name__ == "__main__":
    ...
    object_presence_multi_image_all_count = {}
    object_presence_multi_image_success_count = {}

    character_attributes_all_count = {}
    character_attributes_success_count = {}
    character_attributes_detect_count = {}
    character_attributes_multi_image_all_count = {}
    character_attributes_multi_image_success_count = {}
    character_attributes_multi_image_detect_count = {}


    character_locations_all_count = 0
    character_locations_success_count = 0
    character_locations_multi_image_all_count = {}
    character_locations_multi_image_success_count = {}
    ...
    overall_json["object_presence_success_count"] = object_presence_success_count
    ...
    with open(os.path.join(args.output_log_dir, args.output_name_prefix + "_" + str(random_num) + "_overall_eval.json"), "a") as f:
        json.dump(overall_json, f)


    with open(os.path.join(args.output_log_dir, args.output_name_prefix + "_" + str(random_num) + "_no_found_image.json"), "a") as f:
