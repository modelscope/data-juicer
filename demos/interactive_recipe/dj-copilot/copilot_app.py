# -*- coding: utf-8 -*-
"""
Modified from https://github.com/modelscope/agentscope/blob/main/applications/multisource_rag_app/src/copilot_app.py
...
def initializations() -> None:
    ...
    prepare_docstring_txt(
        repo_path=os.getenv("PATH_TO_DJ_REPO"),
        text_dir=os.getenv("TEXT_DIR", "assert/text_material"),
    )
    global knowledge_bank
...
def run_query(
    ...
    **kwargs: Any,
    ...
    assert isinstance(agent_response_msgs, dict)
