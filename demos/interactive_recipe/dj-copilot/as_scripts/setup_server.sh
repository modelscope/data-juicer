...
export PATH_TO_DJ_REPO=/mnt/d/work/data-juicer # Change to your data-juicer repo absolute path
export TEXT_DIR=./asset/text_material

export RAG_AGENT_NAMES='tutorial_agent,recipe_agent,code_agent,api_agent'
