...
| generate_qa_from_text_mapper                        | General            | en, zh | Generate question and answer pairs from text samples.                                                                                                                            |
| fix_unicode_mapper                                  | General            | en, zh | Fixes broken Unicodes (by [ftfy](https://ftfy.readthedocs.io/))                                                                                                                |
| generate_qa_from_examples_mapper                    | General            | en, zh | Generate question and answer pairs from examples samples.                                                                                                                                             |
...
| optimize_query_mapper                               | General            | en, zh | Optimize instruction query samples.                                                                                                                                             |
