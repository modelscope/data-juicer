...
| optimize_prompt_mapper | 🚀GPU 🌊vLLM 🧩HF 🔗API 🟡Beta | Mapper to optimize prompts based on the existing ones. 映射器根据现有的优化提示。 | [info](operators/mapper/optimize_prompt_mapper.md) | - |
