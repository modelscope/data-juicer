...
#### ✨ explanation 解释
This test converts Simplified Chinese to Traditional Chinese. The operator will change all Simplified Chinese characters in the text to their Traditional Chinese equivalents, while keeping any non-Chinese characters or already Traditional Chinese characters unchanged. For example, '这是' is converted to '這是', and '简体字' is converted to '簡體字'.
此测试将简体中文转换为繁体中文。算子会将文本中的所有简体中文字符转换为其对应的繁体中文字符，而非中文字符或已经是繁体中文的字符则保持不变。例如，“这是”被转换为“這是”，“简体字”被转换为“簡體字”。
...
#### ✨ explanation 解释
This test converts Traditional Chinese to Japanese Kanji. The operator will change Traditional Chinese characters to their corresponding Japanese Kanji, while other characters remain unchanged. For instance, '心臟瓣膜' is changed to '心臓弁膜', and '缺航' is transformed to '欠航'.
此测试将繁体中文转换为日文汉字。算子会将繁体中文字符转换为其对应的日文汉字，而其他字符则保持不变。例如，“心臟瓣膜”被转换为“心臓弁膜”，“缺航”被转换为“欠航”。
