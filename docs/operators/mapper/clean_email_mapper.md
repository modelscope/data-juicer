...
此算子从文本样本中移除电子邮件地址，并用空字符串替换。在给出的例子中，'euqdh@cjqi.com'、'rdash@hqbchd.ckdhnfes.cds' 和 '23da44sh12@46hqb12chd.ckdhnfes.comd.dasd.asd.dc' 因匹配电子邮件模式而被移除，而 'dasoidhao@1264fg.45om' 未被识别为有效的电子邮件地址，因此保持不变。
...
此算子将文本样本中的电子邮件地址替换为指定的字符串'<EMAIL>'。在给出的例子中，'euqdh@cjqi.com'、'rdash@hqbchd.ckdhnfes.cds' 和 '23da44sh12@46hqb12chd.ckdhnfes.comd.dasd.asd.dc' 被替换为 '<EMAIL>'，而 'dasoidhao@1264fg.45om' 未被识别为有效的电子邮件地址，因此保持不变。
