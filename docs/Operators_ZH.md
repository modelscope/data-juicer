...
| generate_qa_from_examples_mapper                   | General               | en, zh    | 根据种子数据，生成新的对话样本。                                                    |
| generate_qa_from_text_mapper                       | General               | en, zh    | 从文本中生成问答对                                                              |
...
| optimize_query_mapper                              | General               | en, zh    | 指令优化，优化 query                                                         |
| optimize_response_mapper                           | General               | en, zh    | 指令优化，优化 response                                                         |
