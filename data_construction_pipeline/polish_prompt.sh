python data_construction_pipeline/polish_prompt.py \
...
--output_json ./playground/data_construction/docci_polished_prompt.json \
--gpu_nums 1
...
--output_json ./playground/data_construction/flickr30k_polished_prompt.json \
--gpu_nums 1
...
--output_json ./playground/data_construction/coco_polished_prompt.json \
--gpu_nums 1