...
def compute_pr(opts, max_real, num_gen, nhood_size, row_batch_size, col_batch_size, use_image_dataset=True):
    ...
    real_features = metric_utils.compute_feature_stats_for_dataset(
        ...
        rel_lo=0, rel_hi=0, capture_all=True, max_items=max_real, use_image_dataset=use_image_dataset).get_all_torch()
    ...
    gen_features = compute_gen_stats_fn(
        ...
        rel_lo=0, rel_hi=1, capture_all=True, max_items=num_gen, use_image_dataset=use_image_dataset).get_all_torch()
